// src/lib/projects.js
console.log('Projects: projects.js module loaded');

export const projects = [
  {
    title: "Bitcoin Trade Signals",
    description: "A custom dashboard for real-time Bitcoin metrics, price, RSI, and trading signals.",
  ...
  },
  {
    ...
    description: "Simulates blockchain mechanics like transactions and blocks.",
  ...
  {
    title: "PDF Merger",
    description: "Merges multiple PDFs into one file.",
  ...
  },
  {
    ...
    description: "Downloads and analyses raw YouTube video transcripts.",
  ...
  },
  {
    ...
    description: "Simulates irrigation devices for agriculture, tracking sensor data.",
  ...
  },
  {
    ...
    description: "CLI tool to check the current Bitcoin block height.",
